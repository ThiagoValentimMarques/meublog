...
Os gráficos apresentados nest post foram utilizados na [live de hoje](https://youtu.be/EuobfijcJYY) no canal do [Instagram](https://www.instagram.com/edmilsoncamposprof/) do Professor Edmilson Campos, Diretor Geral do IFRN Campus Natal - Zona Norte. No bate-papo, foram abordados os seguintes tópicos:
...
#### **Gráfico 4**: Casos acumulados (curva azul) e óbitos (curva vermelha) por Covid-19 no Brasil
...
dados <- read.csv("C:\\Users\\Thiago\\Documents\\Git\\meublog\\static\\datasets\\COVID19_20200507.csv",header=TRUE,sep=";")
